...
const NAVIGATION_ITEMS = [
  ...
  // ✅ Worker self-service portal — only shown to workers (not admins who use /dashboard/worker)
    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="p-4 border-b border-sidebar-border">
          ...
          {canSwitchStore ? (
            /* Admin/super_admin — show the dropdown to switch stores */
            <select
            ...
            /* Workers — show a read-only pill (they can't switch stores) */
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-0.5">
          {visibleItems.map(item => {
            ...
            // ✅ Visual separator before "My Workspace" to distinguish it
            const isPortalLink = item.href === '/worker-portal';
